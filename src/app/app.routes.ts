...
export const routes: Routes = [
  ...
  { path: 'vendor/schedules', loadComponent: () => import('./pages/vendor/vendor-schedules/vendor-schedules').then(m => m.VendorSchedules), canActivate: [authGuard, vendorGuard] },
  { path: 'vendor/blocks', loadComponent: () => import('./pages/vendor/vendor-blocks/vendor-blocks').then(m => m.VendorBlocks), canActivate: [authGuard, vendorGuard] },
  { path: 'vendor/bookings', loadComponent: () => import('./pages/vendor/vendor-bookings/vendor-bookings').then(m => m.VendorBookings), canActivate: [authGuard, vendorGuard] },
