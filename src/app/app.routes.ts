...
export const routes: Routes = [
  ...
  { path: 'dashboard/courts/:id/edit', loadComponent: () => import('./pages/courts/court-form/court-form').then(m => m.CourtForm), canActivate: [authGuard, vendorGuard] },
  { path: 'dashboard/schedules', loadComponent: () => import('./pages/vendor/vendor-schedules/vendor-schedules').then(m => m.VendorSchedules), canActivate: [authGuard, vendorGuard] },
  { path: 'dashboard/blocks', loadComponent: () => import('./pages/vendor/vendor-blocks/vendor-blocks').then(m => m.VendorBlocks), canActivate: [authGuard, vendorGuard] },
  { path: 'dashboard/bookings', loadComponent: () => import('./pages/vendor/vendor-bookings/vendor-bookings').then(m => m.VendorBookings), canActivate: [authGuard, vendorGuard] },
  { path: 'dashboard/vendors/:id', loadComponent: () => import('./pages/vendor/vendor-detail/vendor-detail').then(m => m.VendorDetail), canActivate: [authGuard, vendorGuard] },
